...
| **notwindstone**        | [#77 Implement a CI action to build the mod on commits](https://github.com/Ultrad00d/MnA_Extra_Cantrips/issues/77) | [PR for #77](https://github.com/Ultrad00d/MnA_Extra_Cantrips/pull/83) | reviews | [CI action to build the mod on commits](https://github.com/Ultrad00d/MnA_Extra_Cantrips/issues/77), quality tests | documentation |
