...
| **notwindstone**        | [#77 Implement a CI action to build the mod on commits](https://github.com/Ultrad00d/MnA_Extra_Cantrips/issues/77) | [PR for #77](https://github.com/Ultrad00d/MnA_Extra_Cantrips/pull/83) | [Review for Force Consume Basic Functionality](https://github.com/Ultrad00d/MnA_Extra_Cantrips/pull/96) | [CI action to build the mod on commits](https://github.com/Ultrad00d/MnA_Extra_Cantrips/issues/77), quality tests | documentation |
